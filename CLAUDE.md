# SML Fleet — Project Requirements Document (PRD)
...
import (
    ...
    "sml-fleet/internal/mcp"
    "sml-fleet/internal/ucp"
...
# PostgreSQL
POSTGRES_URI=postgres://smlfleet:password@localhost:5432/smlfleet?sslmode=disable
...
services:
  ...
  mongodb:
    ...
    environment:
      MONGO_INITDB_DATABASE: smlfleet
  ...
  postgres:
    ...
    environment:
      POSTGRES_DB: smlfleet
      POSTGRES_USER: smlfleet
      POSTGRES_PASSWORD: smlfleet_password
...
*Project: SML Fleet by SML AI Solution Co., Ltd.*